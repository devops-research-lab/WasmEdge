...
TEST(WasiP3Cli, InstanceNamesAreTheInterfaceIds) {
  ...
  auto Insts = Host::WasiP3::newCliInstances(Env);
...
TEST(WasiP3Cli, ExitRecordsTheCodeAndTerminates) {
  ...
  auto Ok = call(
      ...
      {Runtime::Component::Wit<
          Expected<Runtime::Component::WitUnit, Runtime::Component::WitUnit>>::
           into(Runtime::Component::WitUnit{})});
  ASSERT_FALSE(Ok);
  ...
  auto Err = call(
      ...
      {Runtime::Component::Wit<
          Expected<Runtime::Component::WitUnit, Runtime::Component::WitUnit>>::
           into(Unexpected<Runtime::Component::WitUnit>(
