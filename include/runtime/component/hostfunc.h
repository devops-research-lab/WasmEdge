...
/// The table of the host objects behind a resource type. A representation is
/// a one-based slot number under the generation of the slot, so a stale one
/// never names the object that took its slot.
